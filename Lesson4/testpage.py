...
# ENTER TEXT
    ...
    def enter_pass(self, word):
        self.enter_text_info_field(TestSearchLocators.ids ["LOCATOR_PASS_FIELD"], word, description="pass form")
    ...
    def enter_name(self, word):
        self.enter_text_info_field(TestSearchLocators.ids ["LOCATOR_NAME"], word, description="name form")

    def enter_email(self, word):
        self.enter_text_info_field(TestSearchLocators.ids ["LOCATOR_EMAIL"], word, description="email form")

    def enter_content2(self, word):
        self.enter_text_info_field(TestSearchLocators.ids ["LOCATOR_CONTENT2"], word, description="content2 form")
...
# CLICK
    ...
    def click_contactus_btn(self):
        self.click_button(TestSearchLocators.ids ["LOCATOR_CONTACTUS_BTN"], description="contact us")
